...
static void tl2796_cfg_gpio(struct platform_device *pdev)
{
	...
	//20100713_inchul... (NC in Atlas) s3c_gpio_cfgpin(S5PC11X_GPJ2(4), S5PC11X_GPJ2_4_GPIO_INT20_4);
...
static unsigned int jupiter_gpio_table[][8] = {
	...
	{S5PC11X_GPJ1(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
        ...
        {S5PC11X_GPJ1(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
        {S5PC11X_GPJ1(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN,
			 S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST, S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
...
static void smdkc110_power_off (void) 
{
    ...
    while(1)
    {
        // Reboot Charging
//        if (maxim_chg_status())
        if (Get_MAX8998_PM_REG(VDCINOK_status))	// ECIM 2879082
        {
...
static unsigned int jupiter_sleep_gpio_table[][3] = {
	...
	{S5PC11X_GPA0(3),
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PC11X_GPA0(4), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, //20100722_inchul.im... input pull down(from HW)
	{S5PC11X_GPA0(5),
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PC11X_GPA0(6), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, //20100722_inchul.im... input pull down(from HW)
...
#endif
        {S5PC11X_GPG3(3), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP}, //20100722_inchul.im... input pull up(from HW)
        {S5PC11X_GPG3(4), 
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
        {S5PC11X_GPG3(5), 
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
...
#if 1
	{S5PC11X_GPI(0), 
			  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, //20100723_inchul
        {S5PC11X_GPI(1), 
			  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, //20100723_inchul
        {S5PC11X_GPI(2), 
			  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN}, //20100723_inchul
	...
	{S5PC11X_GPJ2(0), 
        ...
        {S5PC11X_GPJ2(1), 
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
        {S5PC11X_GPJ2(2), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, //20100723_inchul
        {S5PC11X_GPJ2(3), 
			  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
        {S5PC11X_GPJ2(4), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, //20100713_inchul... input pull down(HW req)
        {S5PC11X_GPJ2(5), 
			  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, //20100713_inchul... input pull down(HW req)
#if defined CONFIG_ARIES_VER_B0 || defined CONFIG_ARIES_VER_B1|| defined CONFIG_ARIES_VER_B2 || (defined CONFIG_ARIES_VER_B3)		  
		{S5PC11X_GPJ2(6), 
...
void s3c_config_sleep_gpio(void)
{
	...
	//s3c_gpio_cfgpin(S5PC11X_GPH1(6), S3C_GPIO_INPUT);   //suik_Fix
	...
	s3c_gpio_setpull(S5PC11X_GPH1(7), S3C_GPIO_PULL_NONE); //20100722_inchul.im... input pull none(from HW)
...
#if 1	//Open Send end
	s3c_gpio_cfgpin(S5PC11X_GPH2(2), S3C_GPIO_INPUT);
	...
	s3c_gpio_setpin(S5PC11X_GPH2(3), 1);	// hanapark (Fix: BATT_ID high) 20100422
...
//	s3c_gpio_setpin(S5PC11X_GPH3(3), 0);
	...
	s3c_gpio_setpull(S5PC11X_GPH3(5), S3C_GPIO_PULL_DOWN);
...
MACHINE_START(SMDKC110, "SCH-I500")
