...
#if defined(CONFIG_PLAT_S3C64XX) || defined(CONFIG_PLAT_S5PC1XX) || defined(CONFIG_PLAT_S5P64XX) || defined(CONFIG_PLAT_S5PC11X) 
...
#define S3C6400_UCON_CLKMASK	(1<<10)
#else
#define S3C6400_UCON_CLKMASK	(3<<10)
#endif
#define S3C2410_UCON_RXDMAMODE_MASK     (0x3)
#define S3C2410_UCON_TXDMAMODE_MASK     (0xc)
#define S3C2410_UCON_RXDMAMODE_SIG0     (2)
#define S3C2410_UCON_TXDMAMODE_SIG0     (2 << 2)
#define S3C2410_UCON_RXDMAMODE_SIG1     (3)
#define S3C6400_UCON_PCLK	(0<<10)
#define S3C6400_UCON_PCLK2	(2<<10)
#define S3C6400_UCON_UCLK0	(1<<10)
#if defined(CONFIG_CPU_S5PC110)
#define S3C6400_UCON_UCLK1	(1<<10)
#else
...
#define S3C2440_UFCON_RXTRIG2	  (0<<4)
#define S3C2440_UFCON_RXTRIG4	  (1<<4)
#define S3C2440_UFCON_RXTRIG6	  (2<<4)
#define S3C2440_UFCON_RXTRIG8	  (3<<4)
#define S3C2440_UFCON_RXTRIG10	  (4<<4)
#define S3C2440_UFCON_RXTRIG12	  (5<<4)
#define S3C2440_UFCON_RXTRIG14	  (6<<4)
#define S3C2440_UFCON_RXTRIG16	  (7<<4)

#define S3C2440_UFCON_TXTRIG0	  (0<<8)
#define S3C2440_UFCON_TXTRIG2	  (1<<8)
#define S3C2440_UFCON_TXTRIG4	  (2<<8)
#define S3C2440_UFCON_TXTRIG6	  (3<<8)
#define S3C2440_UFCON_TXTRIG8	  (4<<8)
#define S3C2440_UFCON_TXTRIG10	  (5<<8)
#define S3C2440_UFCON_TXTRIG12	  (6<<8)
#define S3C2440_UFCON_TXTRIG14	  (7<<8)
...
#define S3C2410_UFCON_DEFAULT	  (S3C2440_UFCON_TXTRIG48 | \
...
/* S3C2413 FIFO trigger levels */
#define S3C_UFCON_RXTRIG1         (0<<4)
#define S3C_UFCON_RXTRIG8         (2<<4)
#define S3C_UFCON_RXTRIG16        (3<<4)
#define S3C_UFCON_RXTRIG32        (4<<4)

#define S3C_UFCON_TXTRIG0         (0<<8)
#define S3C_UFCON_TXTRIG16        (3<<8)
#define S3C_UFCON_TXTRIG32        (4<<8)
#define S3C_UFCON_TXTRIG48        (5<<8)
...
#define S3C_UFSTAT_TXFULL         (1<<24)
#define S3C_UFSTAT_RXFULL         (1<<8)
#define S3C_UFSTAT_TXSHIFT        (16)
#define S3C_UFSTAT_RXSHIFT        (0)
#define S3C_UFSTAT_TXMASK         (255<<8)
#define S3C_UFSTAT_RXMASK         (255)
