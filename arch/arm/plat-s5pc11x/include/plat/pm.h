...
#ifdef CONFIG_PM
extern int s5pc11x_irq_suspend(struct sys_device *dev, pm_message_t state);
extern int s5pc11x_irq_resume(struct sys_device *dev);
#else
#define s5pc11x_irq_suspend	NULL
#define s5pc11x_irq_resume	NULL
#endif
