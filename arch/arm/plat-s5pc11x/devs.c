 ...
 *
 * Base S5PC11X resource and device definitions
 *
...
static struct resource s3c_g2d_resource[] = {
	[0] = {
		.start	= S5PC11X_PA_G2D,
		.end	= S5PC11X_PA_G2D + S5PC11X_SZ_G2D - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
		.start	= IRQ_2D,
...
static struct resource s3c_nand_resource[] = {
        [0] = {
                .start = S5PC11X_PA_NAND,
                .end   = S5PC11X_PA_NAND + S5PC11X_SZ_NAND - 1,
                .flags = IORESOURCE_MEM,
        }
};
...
static struct resource s3c_onenand_resource[] = {
        [0] = {
                .start = S5PC11X_PA_ONENAND,
                .end   = S5PC11X_PA_ONENAND + S5PC11X_SZ_ONENAND - 1,
                .flags = IORESOURCE_MEM,
        }
};
...
static struct resource s3c_ac97_resource[] = {
        [0] = {
                ...
                .end   = S5PC11X_PA_AC97 + S5PC11X_SZ_AC97 -1,
                .flags = IORESOURCE_MEM,
        }
};
...
static struct resource s3c_g3d_resource[] = {
        [0] = {
                .start = S5PC11X_PA_G3D,
                .end   = S5PC11X_PA_G3D + S5PC11X_SZ_G3D - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_3D,
...
static struct resource s3c_jpeg_resource[] = {
        [0] = {
                .start = S5PC11X_PA_JPEG,
                .end   = S5PC11X_PA_JPEG + S5PC11X_SZ_JPEG - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_JPEG,
...
static struct resource s3c_tsi_resource[] = {
        [0] = {
                .start = S5PC11X_PA_TSI,
                .end   = S5PC11X_PA_TSI + S5P_SZ_TSI - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_TSI,
...
static struct resource s3c_cfcon_resource[] = {
        [0] = {
                .start = S5PC11X_PA_CFCON,
                .end   = S5PC11X_PA_CFCON + SZ_1M - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_CFC,
