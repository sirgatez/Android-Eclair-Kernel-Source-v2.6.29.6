...
DEFINE_LOGGER_DEVICE(log_main,   LOGGER_LOG_MAIN,   512*1024) //64 /* Increased from 256 (tkhwang) */
DEFINE_LOGGER_DEVICE(log_events, LOGGER_LOG_EVENTS, 256*1024) //256
DEFINE_LOGGER_DEVICE(log_radio,  LOGGER_LOG_RADIO,  256*1024) //64
